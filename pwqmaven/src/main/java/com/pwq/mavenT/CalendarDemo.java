...
//        System.out.println(str);
        ...
        try
        {
            ...
            // 对 calendar 设置为 date 所定的日期，注意设置的是Date类型
            calendar.setTime(date);//将Date传入

            // 按特定格式显示刚设置的时间
//            str = (new SimpleDateFormat("yyyy-MM-dd HH:mm:ss:SSS")).format(calendar.getTime());//calendar.getTime是得出Date类型
//            System.out.println(str);
        }
